                        ...
                        <div className="w-full md:w-1/2 flex gap-4">
                            <div className="text-xs lg:text-sm font-semibold w-full flex justify-center">
                                <button
                                    ...
                                    className="w-full hover:text-[#ff6741] bg-transparent hover:bg-white text-white border border-white transition-all rounded-lg p-2 font-sans"
                                >
                                    SUBMIT
                                </button>
                            </div>
