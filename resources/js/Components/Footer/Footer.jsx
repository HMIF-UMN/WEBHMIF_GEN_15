...
function Footer() {
    return (
        <div className="flex w-full bg-if-black mx-auto text-white py-12 sm:py-9 justify-center flex-col lg:flex-row gap-4 lg:gap-6 px-16 lg:px-48">
            <motion.div
                initial={{ opacity: 0 }}
                whileInView={{ opacity: 1 }}
                transition={{ duration: 1.5 }}
                viewport={{ once: false, amount: 0.1 }}
                className="lg:flex lg:gap-20"
            >
                <div className="lg:flex lg:gap-8">
                    <div>
                        <div className="flex gap-6 sm:gap-4 max-w-xs">
                            <svg
                                className="sm:w-20"
                                viewBox="0 0 406 709"
                                fill="none"
                            ...
                            >
                                <path
                                    d="M1.71987 603V478.209H38.1495V524.715H81.1675V478.209H117.597V603H81.1675V556.494H38.1495V603H1.71987ZM125.441 603V478.209H160.901L191.905 541.573L222.715 478.209H257.983V603H221.553V540.605L201.594 581.685H182.023L161.87 540.605V603H125.441ZM265.814 603V478.209H302.243V603H265.814ZM310.056 603V478.209H403.843V505.337H346.486V526.846H396.48V554.363H346.486V603H310.056Z"
                                    fill="#F0F2F5"
                                />
                                <path
                                    d="M41.1928 707.102C28.6249 707.102 18.6556 704.078 11.2849 698.031C4.00876 691.888 0.370668 683.006 0.370668 671.383V614.402H19.5061V669.965C19.5061 676.958 21.396 682.203 25.1758 685.699C28.9556 689.101 34.2946 690.802 41.1928 690.802C48.091 690.802 53.3828 689.101 57.0681 685.699C60.8479 682.203 62.7379 676.958 62.7379 669.965V614.402H81.8733V671.383C81.8733 683.006 78.2352 691.888 70.959 698.031C63.6828 704.078 53.7608 707.102 41.1928 707.102ZM90.1952 705.685V614.402H109.472L136.262 669.257L163.051 614.402H182.187V705.685H163.051V646.294L141.79 689.951H130.734L109.331 646.294V705.685H90.1952ZM191.215 705.685V614.402H207.799L251.031 675.21V614.402H270.166V705.685H253.582L210.351 644.877V705.685H191.215Z"
                                    fill="#F0F2F5"
                                />
                                <path
                                    d="M388.792 27.155V17.9385H252.161V18.2726C231.775 19.7693 212.047 26.1362 194.641 36.8367C177.235 47.5372 162.661 62.2578 152.146 79.758C144.368 -4.75711 15.8262 0.772785 15.8262 86.1404C15.6762 125.23 49.3493 156.819 88.4114 154.193C68.1177 163.876 50.7475 178.742 38.0598 197.283C25.3721 215.825 17.8174 237.385 16.1608 259.779H15.8262V396.183C64.5241 399.017 110.36 374.501 133.994 334.882V396.183C204.132 400.538 265.547 347.647 270.29 278.212H270.625V277.878C340.175 273.2 393.177 211.83 388.792 141.808H316.518C338.151 131.423 356.409 115.154 369.194 94.8725C381.979 74.5907 388.772 51.1188 388.792 27.155ZM153.38 255.194C158.908 205.574 202.309 164.008 252.219 160.633V259.779H152.85C152.977 258.247 153.15 256.714 153.323 255.194H153.38ZM252.161 36.7631V135.909H152.85C155.059 110.354 166.232 86.3977 184.399 68.2604C202.567 50.123 226.563 38.9689 252.161 36.7631ZM34.2898 86.1404C35.4438 20.738 132.828 20.738 133.994 86.1404C132.816 151.577 35.4438 151.577 34.2898 86.1404ZM143.225 160.241H195.235C160.477 181.185 136.902 219.261 134.317 259.779H34.6822C37.0261 232.641 49.4726 207.365 69.5663 188.939C89.6599 170.512 115.941 160.273 143.225 160.241ZM34.2898 377.381V278.212H133.601C131.39 303.769 120.218 327.727 102.051 345.868C83.8843 364.008 59.8886 375.168 34.2898 377.381ZM152.457 377.381V278.212H251.769C249.56 303.769 238.388 327.729 220.221 345.87C202.054 364.011 178.057 375.17 152.457 377.381ZM270.625 259.41V160.241H369.936C367.727 185.797 356.555 209.755 338.387 227.895C320.22 246.034 296.223 257.19 270.625 259.399V259.41ZM270.625 135.529V36.3714H369.936C367.727 61.9265 356.554 85.8832 338.386 104.02C320.219 122.158 296.222 133.312 270.625 135.518V135.529Z"
                                    fill="#F0F2F5"
                                />
                            </svg>
                            <div className="bg-white w-0.5 sm:h-40 "></div>
                            <svg
                                className="sm:w-24"
                                viewBox="0 0 128 199"
                                fill="none"
                ...
                <div className="flex">
                    <div className="font-work-sans text-lg mt-12 lg:mt-0 flex flex-col flex-none tracking-wider gap-3 lg:gap-36 lg:text-base lg:flex-row lg:justify-center">
            ...
            <motion.div
                ...
                transition={{ duration: 1.5 }}
                viewport={{ once: false, amount: 0.1 }}
                className="grid mt-2 text-if-neutral-300 font-work-sans visible lg:invisible"
            >
                <span className="text-xs">Made with 🤎 by Gen XIV</span>
